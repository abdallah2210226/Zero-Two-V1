ping_photo = "https://t.me/hohcusc9us/242"
start_photo = "https://t.me/hohcusc9us/244"
help_photo = "https://t.me/hohcusc9us/252"
anime_menu = "https://t.me/hohcusc9us/246"
search = "https://t.me/hohcusc9us/248"
profile_pic = "https://t.me/hohcusc9us/250"
...
calcu =  "جاري الحساب ... "
ping="""
⿻ بوت ❲ [{}](https://t.me/{}) ❳  يتم الان تشغيلة علي بينج ↤ ❲ {} ms ❳  .
⿻ البوت قيد التشغيل من ❲ {} ❳ .
⿻ يتم استخدام ❲ {} ❳ من مساحة السيرفر . 
⿻ يتم استهلاك ❲ {} ❳ من المعالج , ويتم استهلاك ❲ {} ❳ من الرام .
"""
unsupscribe =  "أنت لم تشترك في القنوات المطلوبة. الرجاء الاشتراك في جميع القنوات المطلوبة لاستخدام هذا البوت."
start_message = """
⿻ أوهايو {} 👋🏻🎌.
⿻ أهلا بك في بوت ↤ ❲ [{}](https://t.me/{}) ❳  .
⿻ أرسل اسم الانمي لعرض النتائج .
⿻ اضغط علي زر ( بحث عن الانمي )  لعرض نتائج الانمي حسب ( التصنيف , الحرف , النوع ) .
⿻ يمكنك استخدام امر /ai + (الوصف) لتوليد صور بالذكاء الاصطناعي . 
⿻ مطور البوت  ↤ ❲ [{}](https://t.me/{}) ❳  .
⿻ البوت قيد التشغيل من ❲ {} ❳ .
"""

rules = """
- اهلا بك في جروب  <a href="t.me/{}">{}</a>
القوانين :
- أحترام آدمن والمالك
- يمنع السب تنحظر🔇
- منع نشر الروابط📥
...
error = "حدث خطأ"
id_msg = """ ╭━━❰𝐔𝐒𝐄𝐑 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍❱━━➣
┣⪼  𝐍𝐀𝐌𝐄 ⌯ <a href="tg://user?id={}">{}</a>
┣⪼  𝐔𝐒𝐄𝐑 ⌯ {}
┣⪼  𝐈𝐃 ⌯ <code>{}</code>
┣⪼  𝐓𝐘𝐏𝐄 ⌯ {}
┣⪼  𝐃𝐀𝐓𝐄 𝐌𝐒𝐆 ⌯ {}
┣⪼  𝐁𝐈𝐎 ⌯ {} """
profile_message = """*مرحبًا بك في الملف الشخصي!
يرجى اختيار الخيار المناسب :*"""
Quote= """
═══════ ≪ °❈° ≫ ═══════
...
add_star = """
⚠️عملية اضافة تقيم جديدة ⚠️
المستخدم : {}
الانمي : {}
الحالة : اضافة {} نجوم
"""
remove_star = """
⚠️عملية ازالة التقيم جديدة ⚠️
المستخدم : {}
الانمي : {}
"""
add_to_list = """
⚠️عملية إضافة للقائمة ⚠️
المستخدم : {}
الانمي : {}
الحالة: إضافة ل {}
"""
...
remove_from_list = """
⚠️عملية ازالة من القائمة ⚠️
المستخدم : {}
الانمي : {}
"""

welcome_msg = """
𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 <a href="t.me/{}">{}</a>
◎ ─━───━─ 𖡦─━───━─ ◎ 
⿻ 𝑵𝑨𝑴𝑬  ⌯ <a href="tg://user?id={}">{}</a>
⿻ 𝐔𝐒𝐄𝐑 ⌯ @{}
⿻ 𝐈𝐃  ⌯ <code>{}</code>
◎ ─━───━─ 𖡦─━───━─ ◎ 
⿻ 𝑻𝑶 𝑪𝑶𝑵𝑻𝑨𝑪𝑻 𝑻𝑯𝑬 𝑶𝑾𝑵𝑬𝑹 ⌯ <a href="tg://user?id={}">{bot.get_chat(developer_id).first_name}</a>
⿻ 𝑪𝑯𝑨𝑵𝑵𝑬𝑳 ⌯ <a href="t.me/{}">{}</a>
◎ ─━───━─ 𖡦─━───━─ ◎ 
⿻ 𝑻𝑯𝑬 𝑹𝑼𝑳𝑬𝑺  ⌯ /rules""" 
